...
// //   Future<String?> getFarmerIdByPhoneOrEmail(String phoneOrEmail) async {
// //     try {
// //       final token = await TokenService.getAccessToken();
// //       if (token == null) throw Exception('No authentication token');
// //       final response = await http.get(
// //         Uri.parse('${ApiConstants.getFarmerEndpoint}?identifier=$phoneOrEmail'),
// //         headers: {'Authorization': 'Bearer $token'},
// //       );

// //       if (response.statusCode == 200) {
// //         final data = jsonDecode(response.body);
// //         return data['farmerId']?.toString();
// //       } else {
...
// //         type: PopupType.error,
// //         title: 'Error',
// //         message: 'Failed to fetch farmer: $e',
// //         autoDismiss: true,
// //       );
// //       return null;
// //     }
...
// //       // Resolve farmerId
// //       String farmerId = 'admin'; // Default for admin-added products
// //       String farmerName = 'Admin';
// //       String farmerPhone = '';
// //       if (farmerPhoneOrEmail != null && farmerPhoneOrEmail.isNotEmpty) {
// //         final fetchedFarmerId = await getFarmerIdByPhoneOrEmail(
// //           farmerPhoneOrEmail,
// //         );
// //         if (fetchedFarmerId != null) {
// //           farmerId = fetchedFarmerId;
// //           farmerName = 'Farmer'; // Fetch from API if available
// //           farmerPhone =
// //               farmerPhoneOrEmail.contains('@') ? '' : farmerPhoneOrEmail;
// //         } else {
// //           throw Exception('Farmer not found for $farmerPhoneOrEmail');
// //         }
// //       }
