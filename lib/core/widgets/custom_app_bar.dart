...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget _buildActionsSection(
    ...
    return Row(
      ...
      children: [
        // Notifications
        _buildNotificationButton(theme, isLoggedIn, notificationController),
        ...
        if (!isLoggedIn) _buildLoginButton(theme),
      ],
    );
  }
    ...
    return GestureDetector(
      ...
      child: Stack(
        children: [
          ...
          // Enhanced notification badge (removed pulse animation)
